            ...
            <div className='flex md:flex-row flex-col'>
              <div className='md:w-1/2 relative m-10 flex flex-col'>
                <div className='flex flex-col md:items-start items-center'>
                  ...
                  <span className='md:text-2sm md:text-start z-20 text-center md:p-0 md:pt-3 p-12 rounded-full bg-white md:bg-opacity-[0%] md:shadow-none shadow-2xl bg-opacity-[6%] text-2xs font-[400]'>
                    This high-top sneaker is designed to offer you a stylish and comfortable footwear option. The shoe features a blue upper with pink accents, creating a striking contrast. The white sole adds a touch of elegance and durability.
                  </span>
                  <a href='#ws' className='z-20 md:mt-5 w-fit'>
                    <Butt />
                  </a>
                </div>
              </div>
              <div className='relative md:w-1/2 h-full flex items-center'>
                <ParallaxLayer offset={-0.5} speed={-0.15} style={{ zIndex: 10, height: 'fit-content', width: 'fit-content', position: 'absolute', alignItems: 'center' }}>
                  <Image src={Shoe} alt='shoe' width={744} height={514.71} className='w-[344px] md:w-[744px] md:h-[514.71px] md:mx-10 md:mt-[15rem]' />
                </ParallaxLayer>
              </div>
            </div>
          </section>
          <div className='flex bg-white w-full relative'>
            <div className='w-1/2 md:h-fit h-1/2 md:flex md:flex-col p-7 md:z-40 hover:duration-500 hover:shadow-cyan-500/50 rounded-2xl bg-white shadow-2xl m-10'>
            ...
            <div className='w-1/2 relative flex items-center'>
              <ParallaxLayer offset={0} speed={-0.15} style={{ zIndex: 1, height: 'fit-contents', width: 'fit-content', position: 'absolute' }}>
                <Image src={Shoe2} alt='shoe' width={744} height={514.71} className='rotate-12 md:w-[744px] md:h-[514.71px] md:translate-x-[24rem]' />
              </ParallaxLayer>
              <Image src={Price} alt='shoe' width={444} height={222} className='z-20 md:w-[444px] h-fit md:mt-60 mt-40 w-[222px] md:p-6' />
            </div>
          </div>
        </div>
        <div className='z-20 bg-black h-full relative md:mt-20 pt-[100px]'>
          ...
          <div className='flex mx-20 mt-[8rem] text-white'>
            <div className='flex flex-col'>
              <Image src={Jaba} alt='shoe' width={159.082} height={56.124} className='w-[159.082px] h-[56.124px]' />
              <div className='flex'>
                ...
                <div className='w-fit h-fit'>
                  ...
                  <span className='flex flex-col mx-10 m-4'>FAQ</span>
                </div>
              </div>
            ...
            <div className='mx-40 mt-20 flex flex-col text-2xl font-mono font-[400]'>
              Join our Newsletter
              <span className='text-xs font-mono font-[200]'>We’ll send you nice letters. No spam.</span>
              <Buut />
            </div>
          </div>
        </div>
